...
/**
 * Service interface for managing technologies in the Tech Radar. Provides operations for creating, reading, updating, and deleting technologies, as well as filtering and pagination support.
 */
public interface TechnologyService {
   ...
   * @throws dev.ash.techradar.domain.technology.exceptions.TechnologyNotFoundException if technology is not found
   */
   ...
   * @throws dev.ash.techradar.domain.technology.exceptions.DuplicateTechnologyException   if technology with same name exists
   * @throws dev.ash.techradar.domain.technology.exceptions.InvalidTechnologyDataException if request data is invalid
   */
   ...
   * @throws dev.ash.techradar.domain.technology.exceptions.TechnologyNotFoundException    if technology is not found
   * @throws dev.ash.techradar.domain.technology.exceptions.DuplicateTechnologyException   if update would create name conflict
   * @throws dev.ash.techradar.domain.technology.exceptions.InvalidTechnologyDataException if request data is invalid
   */
